...
* Remove unnecessary LccnNormalizerStructureB. Use 'lccnSearchTermProcessor' in linked-data search APIs ([MSEARCH-926](https://folio-org.atlassian.net/browse/MSEARCH-926))
