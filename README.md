...
| KAFKA_CONTRIBUTORS_CONSUMER_PATTERN                | -                         | Custom subscription pattern for Kafka contributor message consumers.                                                                                                                   |
...
| KAFKA_SUBJECTS_CONSUMER_PATTERN                    | -                         | Custom subscription pattern for Kafka subject message consumers.                                                                                                                       |
