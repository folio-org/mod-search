...
| KAFKA_CONTRIBUTORS_TOPIC_PARTITIONS         | 50                        | Amount of partitions for contributors topic.                                                                                                                                          |
| KAFKA_CONTRIBUTORS_TOPIC_REPLICATION_FACTOR | -                         | Replication factor for contributors topic.                                                                                                                                            |
