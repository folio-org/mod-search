...
| BROWSE_CN_ADDITIONAL_REQUEST_SIZE           | 100                       | Provides an additional request size in case if call-numbers have the same shelving order long value. (value doubles every request)                                                    |
