...
| `headingTypeExt`         |   term    | `headingTypeExt == "Title"`                   | Matches authorities with `personalNameTitle`, `sftpersonalNameTitle`, `saftpersonalNameTitle`, `corporateNameTitle`, `sftcorporateNameTitle`, `saftcorporateNameTitle`, `meetingNameTitle`, `sftmeetingNameTitle`, `saftmeetingNameTitle`                                                                                                                                                                                                                                                                                                                                                                                                |
