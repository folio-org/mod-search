...
| searchQueryModifiers | Contains list of modify query processors, which pre-processes incoming query for elasticsearch request. SearchQueryModifier modify query before search                                                                                                                                          |
