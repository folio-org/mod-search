...
public class InstanceBrowseController implements BrowseApi {
  ...
  @Override
  public ResponseEntity<CallNumberBrowseResult> browseInstancesByCallNumber(
    String query, String tenant, Integer limit, Boolean expandAll) {
    var serviceRequest = CallNumberBrowseRequest.of(INSTANCE_RESOURCE, tenant, query, limit, expandAll);
