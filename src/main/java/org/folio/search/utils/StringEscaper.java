...
public class StringEscaper {
  ...
  /**
   * Escapes backslashes by replacing them with a reserved control character.
   *
   * @param input the string to escape, may be null
   * @return the escaped string, or null if input is null
   * @throws IllegalArgumentException if input contains the reserved control character
   */
  public static String escape(String input) {
    ...
    return input.replace(BACKSLASH_CHARACTER, BACKSLASH_ESCAPE_CHARACTER);
  }
