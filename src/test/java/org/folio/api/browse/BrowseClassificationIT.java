...
public abstract class BrowseClassificationIT extends BaseSharedTest {
  ...
  // Primary LC type (42471af9): 89 entries — mix of decimal and LC-style numbers
  private static final String LC_TYPE_ID = "42471af9-7d25-4f3a-bf78-60d29dcf463b";
  // Secondary LC type (ce176ace): 1 entry — "HD1691 .I5 1967"
  private static final String LC2_TYPE_ID = "ce176ace-a53e-4b4d-aa89-725ed7b2edac";
  // Third type (5af5cb9d): 1 entry — "QA76.73.C15"
  ...
  void browseByClassification_allOption_browsingAroundWithPrecedingRecordsCount() {
    ...
    assertThat(actual.getItems())
      ...
      .startsWith(
        classificationBrowseItem("Q9498 .N34 2020", LC_TYPE_ID, 1,
          "Evolutionary Biology: Mechanisms and Patterns", "Scott, Matthew J.", "Lewis, Sharon M."),
        classificationBrowseItem("QA1771 .R93 1975", LC_TYPE_ID, 1, "The Art of Scientific Inquiry",
          "Lopez, Margaret Y.")
      )
      .contains(
        classificationBrowseItem("QA76.73.C15", TYPE3_ID, 1, "Applied Linguistic Theory", true,
          "Moore, Nancy W."),
        classificationBrowseItem("QP7124 .M32 1979", LC_TYPE_ID, 1, "The Blade in the Ice",
          "Hernandez, Carlos M."),
        classificationBrowseItem("RC3154 .V85 1998", LC_TYPE_ID, 1, "Theories of International Relations",
          "Smith, John A.")
      )
      .endsWith(
        classificationBrowseItem("TA5656 .C45 2005", LC_TYPE_ID, 1, "Environmental Law and Policy",
          "Brown, Patricia K."),
  ...
  void browseByClassification_noExactMatch() {
    ...
    assertThat(actual)
      ...
      .isEqualTo(classificationBrowseResult("Q9498 .N34 2020", "QA1771 .R93 1975", 92, List.of(
        classificationBrowseItem("Q9498 .N34 2020", LC_TYPE_ID, 1, "Evolutionary Biology: Mechanisms and Patterns",
  ...
  void browseByClassification_lcOptionConfiguredWithTwoIds() {
    updateLcConfig(List.of(UUID.fromString(LC_TYPE_ID), UUID.fromString(LC2_TYPE_ID)));
    ...
    assertThat(actual)
      ...
      .isEqualTo(classificationBrowseResult("GE1748 .C51 1975", "HM3819 .L23 1998", 90, List.of(
        classificationBrowseItem("GE1748 .C51 1975", LC_TYPE_ID, 1, "Bioethics: Principles and Cases",
          "Gomez, Rachel Y."),
        classificationBrowseItem("HD1691 .I5 1967", LC2_TYPE_ID, 1,
          "A sem\\ntic web primer :0747-0850 & wolves",
          "Ant\\niou, Grigoris matthew", "Van Harmelen, Frank"),
        classificationBrowseItem("HD8236 .Y68 2004", LC_TYPE_ID, 1, "Media Studies and Public Discourse",
          true, "Lee, Christopher Z."),
        classificationBrowseItem("HD8471 .J90 2001", LC_TYPE_ID, 1, "Sociology of Education and Schooling",
          "Moore, Nancy W."),
        classificationBrowseItem("HM3819 .L23 1998", LC_TYPE_ID, 1, "The Dynamics of Social Movements",
          "Anderson, Susan G.")
      )));
  }
  ...
  private static Stream<Arguments> classificationBrowsingDataProvider() {
    ...
    return Stream.of(
      ...
      arguments(aroundIncludingQuery, "507.79", 5, classificationBrowseResult("412.98", "523.06", 89, List.of(
        classificationBrowseItem("412.98", LC_TYPE_ID, 1, "Cultural Methods in Social Science",
          "Green, Deborah O."),
        classificationBrowseItem("475.42", LC_TYPE_ID, 1, "Urban Ecology and Sustainable Cities",
          "White, Daniel P."),
        classificationBrowseItem("507.79", LC_TYPE_ID, 1, "Criminology and Criminal Justice",
          true, "Phillips, Rachel Z.", "Turner, Lawrence B."),
        classificationBrowseItem("508.83", LC_TYPE_ID, 1, "The Digital Transformation of Libraries",
          "Torres, Angela K."),
        classificationBrowseItem("523.06", LC_TYPE_ID, 1, "Structural Analysis in Civil Engineering",
      ...
      arguments(forwardQuery, "507.79", 5, classificationBrowseResult("508.83", "569.95", 89, List.of(
        ...
        classificationBrowseItem("523.06", LC_TYPE_ID, 1, "Structural Analysis in Civil Engineering",
          "Hernandez, Carlos M.", "Davis, Barbara E."),
        classificationBrowseItem("536.02", LC_TYPE_ID, 1, "Monetary Theory and Central Banking",
          "Roberts, Alan X."),
        classificationBrowseItem("537.76", LC_TYPE_ID, 1, "The Neuroscience of Learning and Memory",
          "Nelson, Virginia Q."),
        classificationBrowseItem("569.95", LC_TYPE_ID, 1, "The Fab Four: A Musical Biography",
      ...
      arguments(backwardQuery, "507.79", 5, classificationBrowseResult("307.06", "475.42", 89, List.of(
        classificationBrowseItem("307.06", LC_TYPE_ID, 1, "Cognitive Behavioral Approaches in Therapy",
          "Williams, Robert T."),
        classificationBrowseItem("395.99", LC_TYPE_ID, 1, "Language Acquisition and Development",
          "Anderson, Susan G."),
        classificationBrowseItem("405.55", LC_TYPE_ID, 1, "Ground-water exploration in Al Marj (1964)",
          "Jackson, Mark B."),
        classificationBrowseItem("412.98", LC_TYPE_ID, 1, "Cultural Methods in Social Science",
          "Green, Deborah O."),
        classificationBrowseItem("475.42", LC_TYPE_ID, 1, "Urban Ecology and Sustainable Cities",
      ...
      arguments(aroundIncludingQuery, "Z4056 .U98 1999", 5, classificationBrowseResult("TR9115 .C83 1971",
        null, 89, List.of(
          classificationBrowseItem("TR9115 .C83 1971", LC_TYPE_ID, 1,
            "Architectural History of the Modern Era", "Hill, Michelle M.", "Wright, Lisa I."),
          classificationBrowseItem("Z2364 .G82 1987", LC_TYPE_ID, 1, "Ground water in Sirte, Libya",
            "Davis, Barbara E.", "White, Daniel P."),
          classificationBrowseItem("Z4056 .U98 1999", LC_TYPE_ID, 1, "Chopin: A Life in Music and Exile",
            true, "Thomas, Dorothy C.", "Parker, George D."),
          classificationBrowseItem("Z6032 .E89 1981", LC_TYPE_ID, 1,
