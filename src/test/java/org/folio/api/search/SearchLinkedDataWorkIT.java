...
import static org.folio.support.utils.LinkedDataTestUtils.toInstance;
...
@IntegrationTest
public abstract class SearchLinkedDataWorkIT extends BaseIntegrationTest {
  ...
  void searchByLinkedDataWork_parameterized_singleResult(int index, String query) throws Throwable {
    doSearchByLinkedDataWork(query)
      ...
      .andExpect(jsonPath(toIdValue(toInstance(), 2), is("a b24123456 ")))
      .andExpect(jsonPath(toIdType(toInstance(), 2), is("LCCN")))
      .andExpect(jsonPath(toIdValue(toInstance(), 3), is("0987654321")))
      .andExpect(jsonPath(toIdType(toInstance(), 3), is("IAN")))
