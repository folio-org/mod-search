...
class BrowseControllerTest {
  ...
  void browseInstancesBySubject_positive() throws Exception {
    ...
    var request = new BrowseRequest(INSTANCE_SUBJECT, TENANT_ID, null, query, 25, "value", false, null, true, 12);
  ...
  void browseAuthoritiesByHeadingRef_positive() throws Exception {
    ...
    var request = new BrowseRequest(AUTHORITY, TENANT_ID, null, query, 25, "headingRef", false, null, true, 12);
  ...
  void browseInstancesByCallNumber_positive() throws Exception {
    ...
    var browseRequest = new BrowseRequest(INSTANCE_CALL_NUMBER, TENANT_ID, BrowseOptionType.ALL, query, 5,
      CALL_NUMBER_BROWSING_FIELD, false, null, true, 2);
