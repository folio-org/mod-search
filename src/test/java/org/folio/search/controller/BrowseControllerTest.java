...
class BrowseControllerTest {
  ...
  void browseInstancesBySubject_positive() throws Exception {
    ...
    var request = BrowseRequest.of(INSTANCE_SUBJECT, TENANT_ID, null, query, 25, "value", false, null, true, 12);
  ...
  void browseAuthoritiesByHeadingRef_positive() throws Exception {
    ...
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, null, query, 25, "headingRef", false, null, true, 12);
