...
class SearchAuthorityIT extends BaseIntegrationTest {
  ...
  private static Stream<Arguments> testDataProvider() {
    return Stream.of(
      ...
      arguments("personalName == {value} and headingType==\"Personal Name\"", "\"Gary A. Wills\""),
      arguments("personalName == {value} and authRefType==\"Authorized\"", "\"Gary A. Wills\""),
      arguments("sftPersonalName = {value}", "\"personal sft name\""),
      arguments("sftPersonalName == {value}", "\"a sft personal name\""),
      ...
      arguments("sftCorporateName == {value}", "\"a sft corporate name\""),
      arguments("saftCorporateName = {value} ", "\"name saft\""),
      arguments("saftCorporateName == {value} ", "\"a saft corporate name\""),
      ...
      arguments("sftMeetingName == {value}", "\"a sft conference name\""),
      arguments("saftMeetingName = {value} ", "\"conference saft\""),
      arguments("saftMeetingName == {value} ", "\"a saft conference name\""),
      ...
      arguments("sftGeographicName == {value}", "\"a sft geographic name\""),
      arguments("saftGeographicName = {value} ", "\"geographic saft\""),
      arguments("saftGeographicName == {value} ", "\"a saft geographic name\""),
      ...
      arguments("sftUniformTitle == {value}", "\"a sft uniform title\""),
      arguments("saftUniformTitle = {value} ", "\"title saft\""),
      arguments("saftUniformTitle == {value} ", "\"a saft uniform title\""),
      ...
      arguments("sftTopicalTerm == {value}", "\"a sft topical term\""),
      ...
      arguments("sftGenreTerm == {value}", "\"a sft genre term\""),
