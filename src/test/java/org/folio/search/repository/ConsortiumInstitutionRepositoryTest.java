...
import static org.folio.search.repository.ConsortiumInstitutionRepository.INSTITUTION_INDEX;
...
class ConsortiumInstitutionRepositoryTest {
  ...
  @BeforeEach
  void setUp() {
    lenient().when(indexNameProvider.getIndexName(INSTITUTION_INDEX, TENANT_ID)).thenReturn(INDEX_NAME);
  }
  ...
  void fetchInstitutions_positive() throws IOException {
    ...
    var actual = repository.fetchInstitutions(TENANT_ID, null, limit, offset, sortBy, null);
  ...
  void fetchInstitutions_positive_withTenantFilter() throws IOException {
    ...
    var actual = repository.fetchInstitutions(TENANT_ID, MEMBER_TENANT_ID, limit, offset, sortBy, null);
  ...
  void fetchInstitutions_positive_sortDesc() throws IOException {
    ...
    var actual = repository.fetchInstitutions(TENANT_ID, null, limit, offset, sortBy,
