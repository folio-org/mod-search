...
class AuthorityBrowseServiceTest {
  ...
  void browse_positive_forward() {
    ...
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 5, TARGET_FIELD, true, false, 5);
  ...
  void browse_positive_forward_expandAllIsFalse() {
    var query = "headingRef > s0";
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 5, TARGET_FIELD, false, false, 5);
    var esQuery = rangeQuery(TARGET_FIELD).gt("s0");
    var context = BrowseContext.builder().succeedingQuery(esQuery).succeedingLimit(5).anchor("s0").build();
  ...
  void browse_positive_backward() {
    ...
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 3, TARGET_FIELD, true, false, 3);
  ...
  void browse_positive_forwardIncluding(boolean highlightMatch) {
    var query = "headingRef >= s0";
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 5, TARGET_FIELD, true, highlightMatch, 5);
  ...
  void browse_positive_forwardIncluding_searchResultLowerThanLimit(boolean highlightMatch) {
    var query = "headingRef >= s0";
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 10, TARGET_FIELD, true, highlightMatch, 5);
    var esQuery = rangeQuery(TARGET_FIELD).gte("s0");
  ...
  void browse_positive_backwardIncluding(boolean highlightMatch) {
    var query = "headingRef <= s4";
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 3, TARGET_FIELD, true, highlightMatch, 3);
  ...
  void browse_positive_around() {
    ...
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 5, TARGET_FIELD, true, true, 2);
  ...
  void browse_positive_aroundWithoutHighlighting() {
    var query = "headingRef > s0 or headingRef < s0";
    var request = BrowseRequest.of(AUTHORITY, TENANT_ID, query, 5, TARGET_FIELD, true, false, 2);
