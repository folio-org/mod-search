...
class SubjectBrowseServiceTest {
  ...
  void browse_positive_forwardIncluding(boolean highlightMatch) {
    ...
    var request = BrowseRequest.of(INSTANCE_SUBJECT, TENANT_ID, null, query, 5, TARGET_FIELD, null, "",
      highlightMatch, 5);
  ...
  void browse_positive_backwardIncluding(boolean highlightMatch) {
    ...
    var request = BrowseRequest.of(INSTANCE_SUBJECT, TENANT_ID, null, query, 3, TARGET_FIELD, null, "",
      highlightMatch, 3);
